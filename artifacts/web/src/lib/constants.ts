export const PRICING_TIERS = [
  ...
  },
  {
    ...
    description: "For established multi-location practices — large firms, medical groups, and organizations that demand maximum visibility, advanced analytics, and dedicated account management.",
    features: [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "The Solo Practice plan includes a basic lead capture form \u2014 a clean, professional contact form that captures a visitor\u2019s name, email, phone number, and message. It gets the job done for practices that just need a simple way for prospective clients to reach out.\n\nThe Group Practice plan includes an enhanced lead capture form with additional fields tailored to your practice \u2014 like practice area, preferred appointment time, or referral source. This pre-qualifies your leads so you spend less time on back-and-forth and more time with clients.\n\nThe Enterprise plan includes an advanced lead generation form \u2014 a multi-step, conversion-optimized form designed to guide visitors through a short series of questions. These forms consistently convert at 2\u20133x the rate of standard contact forms because they feel less intimidating and more interactive."
      },
      {
