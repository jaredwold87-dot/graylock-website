  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Every website we build is custom to your business — not a drag-and-drop template. We design your site around your brand, your services, your local market, and the specific clients you’re trying to attract.\n\nThat said, we work from a proven structural framework that lets us move fast (7–10 business days on average after you approve the demo) without sacrificing quality. Think of it like a custom-built home using tested construction methods — not a prefab kit."
      },
      {
