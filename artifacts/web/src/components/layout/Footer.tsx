      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
        ...
        <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-4 flex flex-col">
              ...
              <Link href="/websites-for-well-drillers" className="text-offwhite/85 hover:text-orange font-sans text-[15px] transition-colors">Well Drillers</Link>
              <Link href="/websites-for-cabinet-makers" className="text-offwhite/85 hover:text-orange font-sans text-[15px] transition-colors">Cabinet Makers</Link>
              <Link href="/websites-for-auctioneers" className="text-offwhite/85 hover:text-orange font-sans text-[15px] transition-colors">Auctioneers</Link>
        ...
        <div>
          ...
          <ul className="space-y-4 flex flex-col">
            ...
            <Link href="/terms" className="text-offwhite/85 hover:text-orange font-sans text-[15px] transition-colors">Terms of Service</Link>
            <Link href="/privacy" className="text-offwhite/85 hover:text-orange font-sans text-[15px] transition-colors">Privacy Policy</Link>
            <Link href="/aup" className="text-offwhite/85 hover:text-orange font-sans text-[15px] transition-colors">Acceptable Use Policy</Link>
          </ul>
          {phone && (
            <div className="mt-8">
