    ...
    <section className={cn("relative px-6 md:px-12 overflow-hidden", hideHeader ? "pt-12 pb-28" : "py-28")}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          {PRICING_TIERS.map((tier: any, i: number) => {
            ...
            <ScrollReveal key={tier.name} delay={i * 0.1} className={cn(
              ...
              <div
                ...
                tier.popular
                  ? "bg-[#0f0f0f] border-[#E85D26]/50 shadow-xl shadow-[#E85D26]/10"
              ...
              <div className="mb-7">
                ...
                <h3 className={cn("text-2xl font-display mb-5", tier.popular ? "text-white" : "text-[#1a202c]")}>{tier.name}</h3>
                {tier.isCustom ? (
                  ...
                  <>
                    ...
                    <p className={cn("text-sm font-semibold mt-2 border-t pt-3", tier.popular ? "text-stone border-white/10" : "text-stone border-gray-100")}>
                      + {tier.setup}
                    </p>
                  </>
                )}
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          {isRefresh ? (
                            <span className="flex flex-wrap items-center gap-x-2 gap-y-1">
                              <span className={cn("font-sans text-sm font-semibold", tier.popular ? "text-white" : "text-[#1a202c]")}>
                                {feature}
                              </span>
                              <span className={cn(
                            ...
                            <span className={cn("font-sans text-sm", tier.popular ? "text-white" : "text-[#1a202c]")}>{feature}</span>
                          )}
                        </div>
                        {!tier.isCustom && /site updates/i.test(feature) && (
                          <p className={cn("font-sans text-xs mt-1.5 ml-8 leading-snug", tier.popular ? "text-stone" : "text-[#1a202c]/70")}>
              ...
              {tier.isCustom && (
                <p className={cn(
                  ...
                  tier.popular ? "text-stone" : "text-[#1a202c]/70"
                )}>
        ...
        <ScrollReveal delay={0.5} className="mt-12 text-center">
          ...
          <p className="text-[#1a202c]/70 text-sm font-sans max-w-2xl mx-auto leading-relaxed">
