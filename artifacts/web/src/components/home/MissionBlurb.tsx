...
export function MissionBlurb() {
  return (
    <section className="bg-offwhite py-20 px-6 md:px-12 border-y border-gray-200">
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            <p className="text-orange font-sans font-semibold uppercase tracking-widest text-sm mb-4">Who We Are</p>
            <h2 className="text-3xl md:text-4xl font-display text-charcoal mb-6 leading-tight">
              We Only Work With Practices We Genuinely Want to See Win
            </h2>
          ...
          <ScrollReveal delay={0.15}>
            <div className="flex flex-col gap-5">
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-lg font-display text-charcoal mb-1">Your Success Is Personal</h3>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex gap-4 items-start">
                <div className="w-12 h-12 bg-blue-900/10 rounded-full flex items-center justify-center flex-shrink-0 border border-blue-200/50">
                  <Flag className="text-blue-500" size={22} />
                </div>
                <div>
                  <h3 className="text-lg font-display text-charcoal mb-1">100% American Team</h3>
