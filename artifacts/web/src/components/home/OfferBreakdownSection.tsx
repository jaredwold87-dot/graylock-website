...
export function OfferBreakdownSection() {
  ...
  return (
    <section className="relative bg-[#DAD5D0] py-16 md:py-24 px-6 md:px-12 border-t border-[#AEA7A3]/20">
      <div className="max-w-6xl mx-auto">
        <ScrollReveal className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-display text-[#242323] mb-6 leading-tight">
            We Prove Our Value Before You Pay a Dollar.
          </h2>
          <p className="text-[#4A4644] text-base md:text-lg font-sans leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {offers.map((offer, i) => (
            <ScrollReveal key={i} delay={i * 0.1}>
              <div className="bg-[#ECE8E4] rounded-xl shadow-md hover:shadow-lg transition-shadow border border-[#AEA7A3]/20 h-full overflow-hidden flex flex-col">
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  />
                  <div className="absolute bottom-3 left-3 w-12 h-12 rounded-lg bg-[#795238] flex items-center justify-center text-[#F4F0EC] shadow-lg">
                    {offer.icon}
                  </div>
                </div>
                <div className="p-7 md:p-8 flex-1">
                  <h3 className="text-xl md:text-2xl font-display text-[#242323] mb-3 leading-tight">{offer.title}</h3>
                  <p className="text-[#4A4644] font-sans text-base leading-relaxed">{offer.desc}</p>
                </div>
              </div>
            </ScrollReveal>
          ))}
