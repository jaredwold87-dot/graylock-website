...
export function HeroSection() {
  ...
  return (
    <section className="bg-charcoal pt-16 pb-24 md:pt-24 md:pb-32 overflow-hidden relative">
      ...
      <div className="absolute inset-0" style={{ background: "linear-gradient(to right, rgba(15,17,23,1) 0%, rgba(15,17,23,1) 25%, rgba(15,17,23,0.7) 60%, rgba(15,17,23,0.38) 80%, rgba(15,17,23,0.3) 100%)" }} />
