        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <ScrollReveal>
            ...
            <p className="text-stone text-lg md:text-xl font-sans mb-8 max-w-xl leading-relaxed">
              We build fully custom websites for law firms, private practices, and CPAs — delivered in 7–10 business days. Starting at $199/month. No long-term contracts. You own everything.
            </p>
