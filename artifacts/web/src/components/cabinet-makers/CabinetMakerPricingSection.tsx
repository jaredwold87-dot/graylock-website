...
/**
 * Pricing + Guarantee (spec §4.7): the low-risk first step, without turning
 ...
 * Guardrails (spec): no "exclusive", no automatic-offer implication, no
 * ranking/volume/ROI promises; guarantee language mirrors /pricing.
 */
export function CabinetMakerPricingSection() {
  const sectionRef = useCabinetMakerSectionView<HTMLElement>("cabinet_maker_pricing_view");
      ...
      <div className="max-w-3xl mx-auto text-center">
        <ScrollReveal>
          ...
          <p className="text-[#1A1A1A]/70 font-sans text-lg leading-relaxed mb-8">
            ...
            business before deciding whether the full site is worth moving forward with. If you
            are selected for the active local-market offer, the one-time build fee is waived.
            After launch, your business is on a clear monthly plan with hosting, maintenance,
            support, and refresh benefits while subscribed.
          </p>
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-center justify-center gap-y-3.5 gap-x-8 mb-9 md:mx-[-60px] lg:mx-[-130px]">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[#1A1A1A] font-sans font-semibold text-base md:text-[17px] whitespace-normal sm:whitespace-nowrap">
                One-Time Build Fee Waived for Selected Local-Market Offer
              </span>
            </div>
          </div>
          <div className="flex flex-col items-center gap-5">
            <CTAButton
              href={cabinetMakerGetStartedHref("pricing")}
              variant="funnel"
