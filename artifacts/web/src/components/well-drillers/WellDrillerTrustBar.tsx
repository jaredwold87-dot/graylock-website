...
/**
 * Well-driller variant of the homepage statistics section. Retains the same
 * visual statistic component, citations, animation behavior, and typography —
 * only the audience framing and supporting labels change (spec §4).
 */
const STATS = [
  {
    figure: "50ms",
  ...
  {
    figure: "75%",
    headline: "Judge a business's credibility by its design",
    source: "Stanford Web Credibility Project, BJ Fogg (2002)",
  },
  {
    figure: "94%",
    headline: "Of negative website feedback is design-related",
    source: "Sillence et al. (2004), Interacting with Computers",
  },
];

export function WellDrillerTrustBar() {
  return (
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <ScrollReveal className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          <p className="text-[#B23E16] text-xs font-sans font-bold uppercase tracking-widest mb-3">
            Before They Call, They Compare
          </p>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-display text-[#1a202c] leading-tight">
            When Water Is the Problem, Trust Is the First Requirement.
          </h2>
          <p className="mt-5 text-[#1a202c]/70 font-sans text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
            A homeowner, ranch manager, or project lead is often searching because they need a
            real solution—not another contractor to sort through. Before they call, they compare
            who looks experienced, clear, local, and ready to help. Your website should make that
            choice easier.
          </p>
        </ScrollReveal>
