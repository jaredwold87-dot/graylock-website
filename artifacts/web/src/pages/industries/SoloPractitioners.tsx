...
const data: IndustryPageData = {
  seo: {
    ...
    description:
      "Graylock builds warm, professional websites for therapists, counselors, and solo practitioners in private practice. Custom built in 7–10 days. Starting at $199/mo. Free demo.",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Brighter Vision charges $149–$349/month for template-based sites where you don't own the content. TherapySites is similar. Graylock starts at $199/month for a fully custom site where you own your content and domain. We deliver in 7–10 days and handle everything for you.",
    },
    {
