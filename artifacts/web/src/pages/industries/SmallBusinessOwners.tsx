...
const data: IndustryPageData = {
  seo: {
    ...
    description:
      "Graylock Digital builds high-converting websites for small business owners — fast (7–10 business days), affordable ($79/mo), and fully managed. No tech headaches. Free website review.",
