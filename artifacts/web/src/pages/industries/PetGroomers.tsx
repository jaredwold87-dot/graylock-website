...
const data: IndustryPageData = {
  seo: {
    ...
    description:
      "Graylock builds professional, trust-building websites for pet groomers and grooming businesses. Appointment forms, service menus, local SEO. Built in 7–10 business days. $79/mo. Free demo.",
