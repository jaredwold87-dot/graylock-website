...
import ChiropractorsComplianceSection from "@/components/compliance/ChiropractorsComplianceSection";
import {
  Bone,
  Globe,
  Search,
...
const data: IndustryPageData = {
  ...
  bottomCta: {
    ...
    button: "Request a 15-Minute Discovery Call",
  },
    ...
    <IndustryLandingPage
      ...
      complianceSection={
        <>
          ...
          <ChiropractorsComplianceSection />
        </>
      }
    />
  );
