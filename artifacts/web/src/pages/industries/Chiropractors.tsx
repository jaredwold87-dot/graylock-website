...
const data: IndustryPageData = {
  seo: {
    title: "Websites for Chiropractors | Custom Sites | Graylock Digital",
    description:
      "Graylock builds custom, SEO-optimized websites for chiropractors and chiropractic clinics. Service pages, local SEO, patient inquiry forms. Built in 7–10 business days. No long-term contracts.",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Every Graylock site includes a local SEO foundation. Group Practice and Enterprise plans include full local SEO optimization and Google Business Profile setup — critical for showing up in 'chiropractor near me' and 'back pain relief' searches in your area.",
    },
  ],
  bottomCta: {
