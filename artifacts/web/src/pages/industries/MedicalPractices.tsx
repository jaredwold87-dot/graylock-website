...
const data: IndustryPageData = {
  seo: {
    ...
    description:
      "Graylock builds custom, SEO-optimized websites for medical practices, physicians, and healthcare providers. Provider bios, service pages, patient inquiry forms. Built in 7–10 business days. Starting at $199/mo.",
