...
const data: IndustryPageData = {
  seo: {
    ...
    description:
      "Graylock builds professional, trust-building websites for house cleaners and residential cleaning companies. Quote forms, service pages, local SEO. Built in 7–10 business days. $79/mo. Free demo.",
