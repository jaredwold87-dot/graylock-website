  ...
  return (
    <>
      <SEO
        ...
        description="Get a modern, SEO-optimized website built specifically for your accounting firm. Rank higher on Google, capture more leads, and grow your practice — starting at $69/mo."
