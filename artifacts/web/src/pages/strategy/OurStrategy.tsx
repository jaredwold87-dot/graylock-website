  ...
  return (
    <>
      <SEO
        ...
        description="Graylock's complete approach to getting professional practices found online — website design, SEO, Google Business Profiles, and lead generation."
        ...
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-white/90 font-sans text-lg md:text-xl mb-8 leading-relaxed">
              Request a free 15-minute discovery call. We'll evaluate your current online presence and show you exactly which parts of our strategy would have the biggest impact on your business.
            </p>
