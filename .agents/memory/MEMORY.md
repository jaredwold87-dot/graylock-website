...
- [Lead submission identity](lead-submission-identity.md) — deduplicate retries by submission, never by visitor assignment; popup and header requests must both email.
...
- [Homepage offers](homepage-offer-presentation.md) — editorial statement plus open numbered commitments; card experiment rejected as too SaaS-like.
